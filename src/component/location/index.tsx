      ...
      <LazyDiv className="card location">
        ...
        <div className="location-info">
          ...
          <div className="content">
            ...
            <b>수서역공영주차장 북측</b> 검색
            <br />
            - 수서역 1번 출구앞 공영주차장 (서울 강남구 수서동 735)
            <br />
            * 주차 후
            <br />
            - 정문 앞 셔틀버스 운행 (수서역 1번 출구 앞 셔틀버스 운행. 예식 1시간전부터 10~15분 간격 운행)
          </div>
          <div />
          <div className="content">
            <b>
              ※ 수서 SRT 1번 출구가 아닙니다.
              <br />
              ※ 식후 하객분들은 식물관 내 배치된 주차권을 가지고 셔틀버스를 탑승해주세요. 출차 시 식물관 주차요원에게 주차권을 제시해주세요.
            </b>
          </div>
        </div>
      </LazyDiv>
